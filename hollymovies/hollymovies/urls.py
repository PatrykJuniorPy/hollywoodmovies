...
from viewer.views import Genre, Movie, SubmitableLoginView
from viewer.views import MovieCreateView, create_genre, hello_view, MoviesView, MovieUpdateView, MovieDeleteView
